    ...
    image: (
      <div tw="flex h-full w-full">
        <div tw="flex text-center">
          Beearly is sunsetting, reach out to limone.eth if you still need the
          service up or if need any support
        </div>
      </div>
    ),
    buttons: [
      <Button action="link" key="1" target={"https://beearly.club"}>
        Learn more
      </Button>,
    ],
  };
