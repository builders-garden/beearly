...
export type FarcasterQuery = {
  Socials: {
    Social: Array<{
      ...
      connectedAddresses: Array<{ address: any | null }> | null;
    }> | null;
  } | null;
};
...
export type FarcasterChannelsQuery = {
  FarcasterChannelParticipants: {
    FarcasterChannelParticipant: Array<{ channelId: string }> | null;
  } | null;
};

export type IsFollowingQueryVariables = Exact<{
  fid: Scalars["Identity"]["input"];
  followedNames: InputMaybe<
